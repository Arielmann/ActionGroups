package ariel.actiongroups.main.common.challenges.challengenavigator.view;
...
import ariel.actiongroups.main.common.challenges.challengenavigator.presenter.ChallengeNavigatorPresenter;
import ariel.actiongroups.main.common.challenges.challengenavigator.presenter.ChallengeNavigatorPresenterImpl;
import ariel.actiongroups.main.common.challenges.challengenavigator.tabs.challengeinfo.view.ChallengeInfoTabFrag;
import ariel.actiongroups.main.common.challenges.challengenavigator.tabs.chat.ChatTabFrag;
import ariel.actiongroups.main.common.challenges.challengenavigator.tabs.results.ResultsTabFrag;
...
public class ChallengeNavigationActivity extends ViewPagerActivity {
   ...
   private ActionGroup group;
    ...
    public void createViewPagerAdapter() {
        ...
        adapter.addFragment(new ChallengeInfoTabFrag(), AppStrings.CHALLENGE);
