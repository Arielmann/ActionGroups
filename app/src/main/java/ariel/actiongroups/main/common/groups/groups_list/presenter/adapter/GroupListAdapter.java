...
import ariel.actiongroups.main.common.groups.groups_list.presenter.adapter.view.GroupListAdapterView;
...
public class GroupListAdapter extends RecyclerView.Adapter<GenericViewHolder> implements GroupListAdapterView{
    ...
    */
    ...
    public GroupListAdapter(Context context, OnGroupClicked onGroupClicked, List dataSet) {
    ...
    public GenericViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new GroupRowViewHolder(context, onGroupClicked, view, dataSet);
    }
