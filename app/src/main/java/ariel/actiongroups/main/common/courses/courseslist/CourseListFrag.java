package ariel.actiongroups.main.common.courses.courseslist;
...
public class CourseListFrag extends Fragment implements GenericRecyclerViewInterface, ViewHoldersFactory {
    ...
    @Override
    public GenericViewHolder newViewHolder() {
        return null;
    }
}