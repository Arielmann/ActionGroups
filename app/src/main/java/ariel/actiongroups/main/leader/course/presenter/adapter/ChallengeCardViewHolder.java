package ariel.actiongroups.main.leader.course.presenter.adapter;
...
public class ChallengeCardViewHolder extends GenericViewHolder implements View.OnClickListener {
    ...
    public void setUIDataOnView(int position) {
            ...
            final String name = dataSet.get(position).getChallengeName();
    ...
    public void onClick(View view) {
        GoToScreen.goToNextScreen(context, CreateChallengeActivity.class);
    }
}
